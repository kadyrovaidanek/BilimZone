...
export const RegisterForm = ({
    ...
    const MobileProgress = () => {
        const progressPercentage = ((currentStep +2) / steps.length) * 100;
        const currentStepInfo = steps[currentStep];
        return (
            <div className="md:hidden w-full mb-6">
                <div className="text-sm text-gray-600 mb-2">
                     {currentStep + 2} из {steps.length}: <span className="font-semibold text-gray-800">{currentStepInfo.title}</span>
                </div>
